...
import com.example.febrian.drawerrabu.Adapter.RecylerPesananAdapter;
...
public class PesananFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyler_pesanan);
        ...
        //setting adapter
        recylerAdapter = new RecylerPesananAdapter(dataSet);
